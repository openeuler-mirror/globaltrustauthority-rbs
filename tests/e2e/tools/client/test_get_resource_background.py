"""Unified tools client background resource retrieval tests."""
...
def test_client_get_resource_background_posts_evidence_and_decrypts(
    rbs_cli_binary: Path, rbs_api: Any, agent_config_path: Path
) -> None:
    """Run background evidence retrieval and validate its decrypted JSON result."""
