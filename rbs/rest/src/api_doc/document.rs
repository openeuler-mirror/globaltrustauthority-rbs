...
use rbs_api_types::{
    ...
    ResourceInfoResponse, ResourceListResponse, ResourceResponse, UpdatePolicyRequest,
...
#[openapi(
    ...
    paths(
        ...
        crate::routes::resource::list_resources,
    ...
    components(schemas(
        ...
        ResourceContentResponse, ResourceInfoResponse, ResourceListResponse,
